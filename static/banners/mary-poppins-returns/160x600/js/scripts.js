(function() {
  ...
  function banner() {
    ...
    tl1.call(videoPlay);
    tl1.from('#frame1_release', dur * 4, { autoAlpha: 0 }, 'frame1+=5');
    tl1.from('#cta_exit', dur * 4, { autoAlpha: 0 }, 'frame1+=5');
    ...
    //hover effects
    // document.querySelector('#banner_ad').addEventListener('mouseenter', function() {
