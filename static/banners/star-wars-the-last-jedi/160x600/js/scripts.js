(function() {
  ...
  function banner() {
    ...
    tl1.to('#frame1_release', dur * 4, { autoAlpha: 0 }, 'frame1+=2.5');

    tl1.from('#cta_exit', dur * 4, { autoAlpha: 0 }, 'frame1+=4');
    tl1.from('#frame1_prime', dur * 4, { autoAlpha: 0 }, 'frame1+=4');

    tl1.to('#cta_exit', dur * 4, { autoAlpha: 0 }, 'frame1+=6');
    tl1.to('#frame1_prime', dur * 4, { autoAlpha: 0 }, 'frame1+=6');

    tl1.to('#frame1_release', dur * 4, { autoAlpha: 1 }, 'frame1+=7.25');
    tl1.to('#frame1_release', dur * 4, { autoAlpha: 0 }, 'frame1+=9.25');

    tl1.to('#cta_exit', dur * 4, { autoAlpha: 1 }, 'frame1+=10.5');
    tl1.to('#frame1_prime', dur * 4, { autoAlpha: 1 }, 'frame1+=10.75');
