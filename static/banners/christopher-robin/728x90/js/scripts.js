(function() {
  ...
  function banner() {
    ...
    // Frame 1
    tl1.from('#frame1_bg_pooh', dur * 4, { autoAlpha: 0 }, 'frame1');
    tl1.from('#frame1_pooh', dur * 4, { autoAlpha: 0 }, 'frame1');
    tl1.from('#frame1_tt', dur * 4, { autoAlpha: 0 }, 'frame1+=0.25');
    tl1.from('#frame1_sub', dur * 4, { autoAlpha: 0 }, 'frame1+=0.5');
    tl1.from('#frame1_release', dur * 4, { autoAlpha: 0 }, 'frame1+=0.75');
    tl1.from('#cta_exit', dur * 4, { autoAlpha: 0 }, 'frame1+=1');
    tl1.from('#frame1_legal', dur * 4, { autoAlpha: 0 }, 'frame1+=1.25');
