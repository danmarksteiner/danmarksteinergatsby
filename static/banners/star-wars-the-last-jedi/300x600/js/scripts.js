(function() {
  ...
  function banner() {
    ...
    tl1.from('#frame1_download', dur * 4, { autoAlpha: 0 }, 'frame1+=0.75');
    tl1.from('#frame1_prime', dur * 4, { autoAlpha: 0 }, 'frame1+=1');
    ...
    function endframe() {
      ...
      tl1.from('#endframe_tt', dur * 4, { autoAlpha: 0 }, 'endframe+=0.5');
      tl1.from(
        '#endframe_release',
        dur * 4,
        { autoAlpha: 0 },
      ...
      tl1.from('#cta_exit', dur * 4, { autoAlpha: 0 }, 'endframe+=1');
      tl1.from('#endframe_prime', dur * 4, { autoAlpha: 0 }, 'endframe+=1.25');
    }
