(function() {
  ...
  function switch_release(release_date, pre_release) {
    switch (DateChecker(release_date, pre_release)) {
      ...
      case 'release_2':
        ...
        document.getElementById('video_release').src =
          'images/release2_video.png';
  ...
  function banner() {
    ...
    tl1.call(videoPlay);
    tl1.from('#frame1_bg_pooh', dur * 4, { autoAlpha: 0 }, 'frame1+=0.25');
    tl1.from('#frame1_pooh', dur * 4, { autoAlpha: 0 }, 'frame1+=0.25');
    tl1.from('#frame1_sub', dur * 4, { autoAlpha: 0 }, 'frame1+=0.5');
    tl1.from('#frame1_tt', dur * 4, { autoAlpha: 0 }, 'frame1+=0.75');
    tl1.from('#frame1_release', dur * 4, { autoAlpha: 0 }, 'frame1+=1');
    tl1.from('#cta_exit', dur * 4, { autoAlpha: 0 }, 'frame1+=1.25');
    tl1.from('#frame1_legal', dur * 4, { autoAlpha: 0 }, 'frame1+=1.5');
    tl1.from('#frame1_bg_eeyohh', dur * 4, { autoAlpha: 0 }, 'frame1+=5');
    tl1.from('#frame1_eeyohh', dur * 4, { autoAlpha: 0 }, 'frame1+=5');
    tl1.from('#frame1_bg_piglet', dur * 4, { autoAlpha: 0 }, 'frame1+=10');
    tl1.from('#frame1_piglet', dur * 4, { autoAlpha: 0 }, 'frame1+=10');
    tl1.from('#frame1_piglet_scarf', dur * 4, { autoAlpha: 0 }, 'frame1+=10');
    tl1.from('#frame1_bg_tigger', dur * 4, { autoAlpha: 0 }, 'frame1+=15');
    tl1.from('#frame1_tigger', dur * 4, { autoAlpha: 0 }, 'frame1+=15');
    tl1.from('#frame1_bg_pooh2', dur * 4, { autoAlpha: 0 }, 'frame1+=20');
    tl1.from('#frame1_pooh2', dur * 4, { autoAlpha: 0 }, 'frame1+=20');
